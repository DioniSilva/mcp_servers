...
```bash
npm install -g ./shared-catalog-mcp-server-0.4.0.tgz
shared-catalog-mcp
```
...
The command creates a file such as `shared-catalog-mcp-server-0.4.0.tgz`. This file is a local artifact and should not be committed.
