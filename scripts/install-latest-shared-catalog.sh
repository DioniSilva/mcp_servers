...
SERVER="shared-catalog"
PACKAGE_NAME="shared-catalog-mcp-server"
TAG_PREFIX="${SERVER}-v"

usage() {
  cat <<'USAGE'
Install or update the latest shared-catalog MCP server release.
...
echo "Use the MCP command: shared-catalog-mcp"
